...
# k = 1 (linear)
ode = @ODEmodel(
    S'(t) = -beta * S(t) * I(t) // (1 + alpha * I(t))^2,
    I'(t) = beta * S(t) * I(t)//(1 + alpha * I(t))^2 - gamma * I(t),
    #R'(t) = gamma*I(t),
    y(t) = I(t)
)


println("Global identifiability of $(beta//gamma*S/(1+alpha*I)^2): ", assess_identifiability(ode, funcs_to_check=[beta//gamma*S/(1+alpha*I)^2], loglevel=Logging.Warn))
# GLOBAL
