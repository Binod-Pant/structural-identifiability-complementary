...
#SIR with unknown N
ode = @ODEmodel(
S'(t) = -beta*S(t)*I(t)/(1-D),
I'(t) = beta*S(t)*I(t)/(1-D) - gamma*I(t),
D'(t) = phi*gamma*I(t),
y(t) = phi*gamma*I(t)
)

println("Global identifiability of $(beta//gamma*S/1): ", assess_identifiability(ode, funcs_to_check=[beta//gamma*S/1], loglevel=Logging.Warn))
# GLOBAL
